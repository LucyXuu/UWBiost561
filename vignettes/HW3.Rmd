...
```{r}
knitr::include_graphics("first_20_lines.png")
knitr::include_graphics("last_20_lines.png")
```
...
I think I will be doing data analyzing functions that can first clean the data and then perform different types of analysis, return them so users can compare between
